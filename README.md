...
This repository contains everything needed to build a fully automated GitOps environment. It packages infrastructure, application manifests, and tooling to let you spin up a local [k3d](https://k3d.io/) based Kubernetes cluster, deploy the stack through Argo CD, and validate that the environment is healthy.
